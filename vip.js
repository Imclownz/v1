/**
 * ==============================================================================
 * TARGETING & LOCK-HEAD SYSTEM v51.0 (QUANTUM REACH - OB RESISTANT)
 * Architecture: Recursive Schema-Agnostic Engine + Vertical Slingshot
    ...
    processRecursive(obj, selfVel = {x: 0, y: 0, z: 0}, ping = 20, dist = 15.0) {
        ...
        for (const boneName of Object.keys(obj)) {
            ...
            if (boneName === 'head' && obj[boneName] && typeof obj[boneName] === 'object' && 'snap_weight' in obj[boneName]) {
                ...
                obj[boneName].vertical_magnetism_multiplier = 15.0; 
                obj[boneName].friction = 0.0;
            }
        ...
        if (obj.center_of_mass && obj.head_pos && obj.chest_pos) {
            ...
            const predictedPos = AdvancedMath.predictIntercept(obj.head_pos, targetVel, selfVel, dist, ping);
            ...
            obj.center_of_mass.y = AdvancedMath.clamp(obj.center_of_mass.y, obj.chest_pos.y, safetyCeiling);
        }
...
if (typeof $response !== "undefined" && $response.body) {
    try {
        ...
        const Engine = new QuantumRecursionEngine();
